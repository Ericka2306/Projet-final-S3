...
<head>
    ...
    <title>Welcome To Takalo Takalo</title>
    <!-- Custom CSS -->
            ...
            <div class="auth-box row">
                ...
                <div class="col-lg-5 col-md-7 bg-white">
                    <div class="p-3">
                        ...
                        <?php echo form_open('Check/verification') ?>
                            <div class="row">
                                <div class="col-lg-12">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" name="mdp" id="pwd" type="password"
                                ...
                                <div class="col-lg-12 text-center mt-5">
                                    ...
                                    <?php } ?>
                                    Don't have an account? <a href="<?php echo site_url('Load/voir/Register') ?>" class="text-danger">Sign Up</a>
                                </div>
                            </div>
                        <?php echo form_close(); ?> 
                    </div>
