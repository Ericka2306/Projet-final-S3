...
<div class="row">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <?php echo form_open('Back_Office/modifier') ?>
                    <div class="form-group">
                        ...
                        <input type="hidden" class="form-control" id="nametext" aria-describedby="name"
                               placeholder="Nom" name="id" value="<?php echo $id ?>">
